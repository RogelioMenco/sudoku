 ...
 */
document
  .getElementById('boton_generar')
  .addEventListener('click', generarTamSudoku, false);
document
  .getElementById('boton_verificar')
  .addEventListener('click', veriSudo, false);
document
  .getElementById('boton_resolver')
  .addEventListener('click', resuelveSudoku, false);
